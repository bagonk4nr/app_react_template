...
class ApiNavBarHeader extends React.Component {
        ...
        constructor(props) {
            super(props);
            this.apiUrl = 'http://192.168.100.100:8081/navbarheader';
            this.menus = new NavBarHeader(this);
            this.state = {
                asyncData: < > < />};
                this.newArr = [];
        ...
        export default withRouter(ApiNavBarHeader);